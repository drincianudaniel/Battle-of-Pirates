...
CPlayer::CPlayer(const BackBuffer *pBackBuffer)
{
	...
	m_pSprite = new Sprite("data/Ship1up.bmp", RGB(255, 255, 255));
...
double CPlayer::getShipWidth()
{
	return m_pSprite->width();
}

double CPlayer::getShipHeight()
{
	return m_pSprite->height();
}

void CPlayer::RotateShipLeft() {
	m_pSprite->setSprite("data/Ship1left.bmp", RGB(255, 255, 255));
	pos = 2;
}
void CPlayer::RotateShipRight() {
	m_pSprite->setSprite("data/Ship1right.bmp", RGB(255, 255, 255));
	pos = 2;
}
void CPlayer::RotateShipUp() {
	m_pSprite->setSprite("data/Ship1up.bmp", RGB(255, 255, 255));
	pos = 1;
}
void CPlayer::RotateShipDown() {
	m_pSprite->setSprite("data/Ship1down.bmp", RGB(255, 255, 255));
	pos = 1;
}
...
std::vector<Sprite*> CPlayer::getVectorBullets()
{
	return bullets;
}

int CPlayer::getposP1()
{
	return pos;
}